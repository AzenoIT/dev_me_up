...
class Game(models.Model):
    player_id_1 = models.ForeignKey('players.Player', on_delete=models.CASCADE, related_name='%(class)s')
    player_id_2 = models.ForeignKey('players.Player', on_delete=models.CASCADE, related_name='%(class)s')
